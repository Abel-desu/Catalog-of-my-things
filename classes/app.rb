...
require_relative '../load-classes/author_module'
require_relative '../load-classes/game_module'
require_relative '../load-classes/book_module'
require_relative '../load-classes/label_module'
require_relative '../load-classes/movie_module'
require_relative '../load-classes/source_module'
require_relative '../load-classes/genre_module'
